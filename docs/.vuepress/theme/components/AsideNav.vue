...
<template>
  <div class="aside-nav-wrapper">
    <VPLink class="link" no-icon href="Dochttps://github.com/XingHeYuZhuan/shiguangschedule">
      <VPIcon name="tabler:star" />
      <span class="link-text">{{ locale.star }}</span>
      <span class="vpi-arrow-right" />
    </VPLink>
    <VPLink class="link" no-icon href="Dochttps://github.com/XingHeYuZhuan/shiguangschedule/issues/new/choose">
